...
<section class="text-gray-600 body-font" >
  <div class="container px-5 py-24 mx-auto">
            ...
            <section class="text-gray-600 body-font overflow-hidden"> <!-- 요부분-->
                <div class="container px-5 py-24 mx-auto">
                  <div class="lg:w-4/5 mx-auto flex flex-wrap"><!-- 이 아래부터 캐러셀 예정 -->
                    ...
                    <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="test5.jpg">
                    
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0"><!-- 이 위까지 캐러셀 예정-->
                      <h2 class="text-sm title-font text-gray-500 tracking-widest">가게 이름</h2>
    ...
    <div class="flex flex-wrap -m-4" > <!--style="float: left;   " -->

      <div class="xl:w-1/4 md:w-1/2 lg:w-1/4 p-4">
        <div class="bg-gray-100 p-6 rounded-lg">
          <img class="h-40 rounded w-full object-cover object-center mb-6" src="test1.jpg" alt="content">
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">SUBTITLE</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">가게이름　
                <ul class="flex">별점　　
                <li>
      ...
      <div class="xl:w-1/4 md:w-1/2 lg:w-1/4 p-4">
        <div class="bg-gray-100 p-6 rounded-lg">
          <img class="h-40 rounded w-full object-cover object-center mb-6" src="test2.jpg" alt="content">
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">SUBTITLE</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">가게이름
          <ul class="flex">별점　　
            <li>
      ...
      <div class="xl:w-1/4 md:w-1/2 lg:w-1/4 p-4">
        <div class="bg-gray-100 p-6 rounded-lg">
          <img class="h-40 rounded w-full object-cover object-center mb-6" src="test3.jpg" alt="content">
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">SUBTITLE</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">가게이름
          <ul class="flex">별점　　
            <li>
      ...
      <div class="xl:w-1/4 md:w-1/2 lg:w-1/4 p-4">
        <div class="bg-gray-100 p-6 rounded-lg">
          <img class="h-40 rounded w-full object-cover object-center mb-6" src="test4.jpg" alt="content">
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">SUBTITLE</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">가게이름
          <ul class="flex">별점　　
            <li>
