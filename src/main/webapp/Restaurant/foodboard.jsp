                   ...
                   <img alt="ecommerce" class="pt1 x-80 h-80 object-cover object-center rounded z-10" src="${ct.photo1 }">
					...
					<c:forEach var='cnt' begin='1' end='5'>	
                      ...
                      <div class="flex">
                        ...
                        <button class="flex ml-auto text-white bg-green-900 border-0 py-2 px-6 focus:outline-none hover:bg-green-800 rounded" id=ctBtn >예약하기</button>
                        </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="lg:w-4/5 mx-auto flex lg:flex-wrap justify-between"><!-- 이 아래부터 캐러셀 예정 -->
                   ...
                   <img alt="ecommerce" class="pt2  x-80 h-80 object-cover object-center rounded z-10" src="${ct1.photo1 }" >
					...
					<c:forEach var='cnt' begin='1' end='5'>	
                      ...
                      <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900"></span>
                  <button class="flex ml-auto text-white bg-green-900 border-0 py-2 px-6 focus:outline-none hover:bg-green-800 rounded" id=ct1Btn>예약하기</button>     
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                <div class="container px-5 py-24 mx-auto">
                  <div class="lg:w-4/5 mx-auto flex lg:flex-wrap justify-between"><!-- 이 아래부터 캐러셀 예정 -->
					...
					<c:forEach var='cnt' begin='1' end='5'>	
                      ...
                      <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900"></span>
                     	<button class="flex ml-auto text-white bg-green-900 border-0 py-2 px-6 focus:outline-none hover:bg-green-800 rounded" id=ct2Btn>예약하기</button>
...
<c:set var="star" value="1" />
	...
	<c:forEach var="dto" items="${list }">
      ...
      <a href="/load.rest?seq=${dto.seq } " >
        <div class="bg-white hover:grow shadow-lg p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">${dto.title }
               ...
               <div class="col-span-1 row-span-3 text-right">
                    ${dto.rate }
                    <ul class="flex justify-end items-center" id="detail">
