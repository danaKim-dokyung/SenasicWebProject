	...
	<div
		...
		<nav class=" justify-between">
			<ul class="nav-container justify-between">
				<li class="nav-itme"><a style="color: black;"
					href="/fboard.rest?cpage=1">맛집 리스트 </a></li>
				<li class="nav-itme md:ml-36 md:mr-36"><a style="color: black;"
					href="/magagineList.mag">맛집 매거진 </a></li>
				<li class="nav-itme "><a style="color: black;"
					href="/list.pet?cpage=1&check_num=2">반려견 게시판 </a></li>
			</ul>
		</nav>
		...
		<nav
            ...
            ${loginID} 님 안녕하세요&nbsp;&nbsp;| &nbsp;&nbsp;
                  <a style="color: black;" href="/logout.mem"
						onclick="return confirm(" 정말로그아웃하시겠습니까?");">로그아웃&nbsp;&nbsp;|</a>&nbsp;&nbsp;
                  <!-- 강사님께 질문 3 -->
					<c:if test="${seqID < 0 }">
...
<script>
	<!-- summernote 이미지가 올라갔을때 callback 함수 -->
